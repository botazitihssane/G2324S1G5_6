...
class StartWorkoutShoulderScreen extends StatelessWidget {
  StartWorkoutShoulderScreen({Key? key}) : super(key: key);
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        SizedBox(
                                                                            width: 307
                                                                                .h,
                                                                            child: Text("Want your body to be healthy. Join our program with directions according to body’s goals. Increasing physical strength is the goal of strenght training. Maintain body fitness by doing physical exercise at least 2-3 times a week. ",
                                                                                maxLines: 6,
                                                                                overflow: TextOverflow.ellipsis,
                                                                                style: CustomTextStyles.bodyMediumWhiteA70015.copyWith(height: 1.40)))
                                                                      ])),
                                                              Align(
                                                                  alignment:
                                                                      Alignment
                                                                      ...
                                                                      child: Row(children: [
                                                                        CustomTextFormField(
                                                                            ...
                                                                            hintText:
                                                                                "60 min",
                                                                            prefix:
                                                                                Container(margin: EdgeInsets.fromLTRB(5.h, 5.v, 6.h, 5.v), child: CustomImageView(imagePath: ImageConstant.imgOverflowmenu, height: 19.adaptSize, width: 19.adaptSize)),
                                                                            prefixConstraints: BoxConstraints(maxHeight: 29.v),
                                                                            contentPadding: EdgeInsets.only(top: 5.v, right: 14.h, bottom: 5.v),
                                                                        ...
                                                                        Padding(
                                                                            ...
                                                                            child: CustomTextFormField(
                                                                                ...
                                                                                prefix: Container(margin: EdgeInsets.fromLTRB(5.h, 5.v, 6.h, 5.v), child: CustomImageView(imagePath: ImageConstant.imgFireWhiteA700, height: 19.adaptSize, width: 19.adaptSize)),
                                                                                prefixConstraints: BoxConstraints(maxHeight: 29.v),
                                                                                contentPadding: EdgeInsets.only(top: 5.v, right: 14.h, bottom: 5.v),
                                                                                borderDecoration: TextFormFieldStyleHelper.fillPrimaryContainer,
                                                                                fillColor: theme.colorScheme.primaryContainer))
